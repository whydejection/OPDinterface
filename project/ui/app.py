...
class App(ctk.CTk):
    ...
    def setup_analysis_page(self) -> None:
        ...
        self.analysis_workspace_canvas.grid_rowconfigure(1, weight=0)  # прогресс
        ...
        self.analysis_progress.grid(row=1, column=0, sticky="ew", padx=12, pady=(0, 12))
        self.analysis_progress.set(0.0)
    ...
    def setup_view_settings(self) -> None:
        ...
        for lbl, vals, opt in [
            ...
            ("Цветовая схема:", list(C.AVAILABLE_COLOR_SCHEMES), "scheme"),
            ("График (вид):", list(C.AVAILABLE_PLOT_MODES), "plot_mode"),
            ...
            if opt == "theme":
                ...
                self.scheme_menu = menu
            elif opt == "plot_mode":
                self.plot_mode_menu = menu
            else:
